...
/// If <code>alternativeAdvertisingNameEnabled</code> is <code>true</code> then this specifies the alternative name to use. If nil (default)
...
/// version:
/// Added in version 4.2 of the iOS DFU Library. Extended in 4.3 to allow setting delegate queues.
/// seealso:
/// peripheralSelector property - a selector used when scanning for a device in DFU Bootloader mode
/// in case you want to update a Softdevice and Application from a single ZIP Distribution Packet.
...
///
/// \param progressQueue The dispatch queue to invoke all progress delegate callbacks on.
///
