...
extension CLKComplicationFamily {
    ...
    private enum Template {
        static let modular: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.modular)!
            return CLKComplicationTemplateModularSmallSimpleImage(imageProvider: .init(onePieceImage: image))
        }()
        ...
        static let modularLarge: CLKComplicationTemplate = {
            ...
            return CLKComplicationTemplateModularLargeStandardBody(headerTextProvider: headerText, body1TextProvider: CLKSimpleTextProvider(text: "Tap to open"))
        }()
        
        static let utilitarianSmall: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.utilitarian)!
            return CLKComplicationTemplateUtilitarianSmallRingImage(imageProvider: .init(onePieceImage: image), fillFraction: 0, ringStyle: .closed)
        }()
        
        static let utilitarianLarge: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.utilitarian)!
            return CLKComplicationTemplateUtilitarianLargeFlat(textProvider: CLKSimpleTextProvider(text: "Sesame"), imageProvider: .init(onePieceImage: image))
        }()
        
        static let circularSmall: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.circular)!
            return CLKComplicationTemplateCircularSmallSimpleImage(imageProvider: .init(onePieceImage: image))
        }()
        
        static let extraLarge: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.graphicExtraLarge)!
            return CLKComplicationTemplateExtraLargeSimpleImage(imageProvider: .init(onePieceImage: image))
        }()
        
        static let graphicCorner: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.graphicCorner)!
            return CLKComplicationTemplateGraphicCornerTextImage(textProvider: CLKTextProvider(format: "Sesame"), imageProvider: .init(fullColorImage: image))
        }()
        
        static let graphicBezel: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.graphicBezel)!
            let circularImg = CLKComplicationTemplateGraphicCircularImage(imageProvider: CLKFullColorImageProvider(fullColorImage: image))
            return CLKComplicationTemplateGraphicBezelCircularText(circularTemplate: circularImg, textProvider: CLKTextProvider(format: "Sesame"))
        }()
        
        static let graphicCircular: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.graphicCircular)!
        ...
        static let graphicRectangular: CLKComplicationTemplate = {
            let headerText = CLKSimpleTextProvider(text: "Sesame")
            headerText.tintColor = .sesame2Green
            return CLKComplicationTemplateGraphicRectangularStandardBody(headerTextProvider: headerText, body1TextProvider: CLKTextProvider(format: "Tap to open"))
        }()
        
        static let utilitarianSmallFlat: CLKComplicationTemplate = {
            let image = UIImage(named: ComplicationIcon.utilitarian)!
            return CLKComplicationTemplateUtilitarianSmallFlat(textProvider: CLKTextProvider(format: "Sesame"), imageProvider: CLKImageProvider(onePieceImage: image))
        }()
    }
