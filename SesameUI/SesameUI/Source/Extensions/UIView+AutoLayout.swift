...
extension UIView {
    ...
    @discardableResult
    func autoEqualHeightTo(_ view: UIView, _ constant : CGFloat = 0) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let heightConstraint = heightAnchor.constraint(equalTo: view.heightAnchor, constant: constant)
        heightConstraint.isActive = true
        return heightConstraint
    }
    ...
    @discardableResult
    func autoPinHeightLessThanOrEqual(_ view: UIView) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let widthConstraint = heightAnchor.constraint(lessThanOrEqualTo: view.heightAnchor)
        widthConstraint.isActive = true
        return widthConstraint
    }
    
    @discardableResult
    func autoPinHeightLessThanOrEqual(constant: CGFloat) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let heightConstraint = heightAnchor.constraint(lessThanOrEqualToConstant: constant)
        heightConstraint.isActive = true
        return heightConstraint
    }
    
    @discardableResult
    func autoPinBottomLessThanOrEqual(_ view: UIView) -> NSLayoutConstraint {
        translatesAutoresizingMaskIntoConstraints = false
        let bottomConstraint = bottomAnchor.constraint(lessThanOrEqualTo: view.bottomAnchor)
...
extension UIView {
    static func restoreHide(views: [UIView]) {
