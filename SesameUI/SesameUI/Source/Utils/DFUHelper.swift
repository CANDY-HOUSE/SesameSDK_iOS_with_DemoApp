...
final class DFUHelper {
    ...
    lazy fileprivate var dfuServiceInitiator: DFUServiceInitiator = {
        ...
        // 註解掉理由: 連續 dfu 出現 Writing to characteristic failed, 參考網路意見並且參考官方最新範例 code
        // https://blog.csdn.net/zthhsa/article/details/73511215
        // https://github.com/NordicSemiconductor/IOS-DFU-Library/blob/master/Example/iOSDFULibrary/View%20Controllers/DFUViewController.swift
