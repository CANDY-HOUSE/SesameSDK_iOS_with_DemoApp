...
class WifiModule2SSIDScanViewController: CHBaseTableViewController {
    ...
    override func viewDidLoad() {
        ...
        noContentText = "candyhouse.util.loading".localized
        ...
        pullToRefreshLabel.autoPinLeading()
        pullToRefreshLabel.autoPinTrailing()
        pullToRefreshLabel.autoPinBottom(constant: -10)
        pullToRefreshLabel.autoLayoutHeight(40)
        pullToRefreshLabel.textAlignment = .center
        pullToRefreshLabel.text = "co.candyhouse.sesame2.scanSSIDPullToRefresh".localized
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.iconView.image = UIImage(named: wifiSignal)
