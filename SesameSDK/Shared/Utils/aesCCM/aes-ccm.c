...
__attribute__ ((visibility ("hidden"))) int aes_ccm_ae(const u8 *key, size_t key_len, const u8 *nonce,
...
/* AES-CCM with fixed L=2 and aad_len <= 30 assumption */
__attribute__ ((visibility ("hidden"))) int aes_ccm_ad(const u8 *key, size_t key_len, const u8 *nonce,
