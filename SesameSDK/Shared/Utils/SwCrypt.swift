...
class CC {
    ...
    class RSA {
        ...
        static func encrypt(_ data: Data, derKey: Data, tag: Data,
        ...
        static func decrypt(_ data: Data, derKey: Data, tag: Data,
                            padding: AsymmetricPadding,
    ...
    class EC {
        ...
        static func getPublicKeyFromPrivateKey(_ privateKey: Data) throws -> Data {
        ...
        static func getPublicKeyComponents(_ keyData: Data) throws -> KeyComponents {
            let key = try importKey(keyData, format: .binary, keyType: .keyPublic)
            defer { CCECCryptorRelease!(key) }
            return try getKeyComponents(key)
        }
        
        static func getPrivateKeyComponents(_ keyData: Data) throws -> KeyComponents {
        ...
        static func createFromData(_ keySize: size_t, _ x: Data, _ y: Data) throws -> Data {
            var pubKey: CCECCryptorRef? = nil
    ...
    class CMAC {
        static func AESCMACWithTime(_ key: Data) -> Data {
