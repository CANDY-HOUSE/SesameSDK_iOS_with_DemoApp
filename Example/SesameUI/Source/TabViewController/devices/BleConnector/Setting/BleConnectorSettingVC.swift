...
//                L.d(error.errorDescription())
    ...
    func arrangeSubviews() {
        ...
        titleLabel.text = "co.candyhouse.sesame2.bindSesame2ToBleConnector".localized
        ...
        dropKeyView.title = String(format: "co.candyhouse.sesame2.TrashTouch".localized, arguments: ["co.candyhouse.sesame2.BLEConnector".localized])
        dropHintView.text = String(format: "co.candyhouse.sesame2.dropKeyDesc".localized, arguments: ["co.candyhouse.sesame2.BLEConnector".localized, "co.candyhouse.sesame2.BLEConnector".localized, "co.candyhouse.sesame2.BLEConnector".localized])
