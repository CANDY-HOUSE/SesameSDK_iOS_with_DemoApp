...
//
//    var isConnectedByWM2: Bool = false
//
//    let productModel = CHProductModel.sesame2
//
...
//    }
//
//    func updateBleAdvParameter(historytag: Data?, interval: Double, txPower: Int8, _ result: @escaping CHResult<CHSesame2BleAdvParameter>) {
//
//    }
//
...
//        return try? JSONDecoder().decode(CHDeviceKey.self, from: Data())
//    }
//
...
//    }
//
//    func loginSesame2(token: String?) {
//
//    }
//}
