...
#ifndef SESAMESDK_SWIFT_H
#define SESAMESDK_SWIFT_H
...
@interface CHBleManager (SWIFT_EXTENSION(SesameSDK)) <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC9SesameSDK11CHDeviceKey")
...
@interface CHDeviceMO (SWIFT_EXTENSION(SesameSDK))
