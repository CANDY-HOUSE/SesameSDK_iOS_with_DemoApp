...
public protocol CHSesame2: class {
    ...
    */
    ...
    // intervalには20ms～10240msまで設定可能ですが、　次のいずれかの値の設定がアップル社のAccessory Design Guidelines for Apple Devices 35.5 Advertising Intervalに推奨されています: [1285.0, 1022.5, 852.5, 760.0, 546.25, 417.5, 318.75, 211.25, 152.5, 20.0] 単位: ms
